...
def gen_user_hist_sessions(model, FRAC=0.25):
    ...
    name = 'data_taobao/sampled_data_old/behavior_log_pv_user_filter_enc_' + str(FRAC) + '.pkl'
    ...
    for i in range(0, iters):
        ...
        pd.to_pickle(user_hist_session, 'data_taobao/sampled_data_old/user_hist_session_' +
